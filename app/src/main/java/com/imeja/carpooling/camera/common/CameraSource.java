...
package com.imeja.carpooling.camera.common;
...
import com.imeja.carpooling.camera.SizeController;
...
public class CameraSource {
  ...
  private static int requestedPreviewWidth = 1280;
  private static int requestedPreviewHeight = 960;
  ...
  public CameraSource(Activity activity, GraphicOverlay overlay) {
    ...
    requestedPreviewWidth = Appcontroller.app.getResources().getDisplayMetrics().widthPixels;
    requestedPreviewHeight = Appcontroller.app.getResources().getDisplayMetrics().heightPixels;
  ...
  private Camera createCamera() throws IOException {
    ...
    SizePair sizePair = SizeController.generateValidPreviewSize(camera, requestedPreviewWidth, requestedPreviewHeight);
    if (sizePair == null) {
    ...
    //setCameraDisplayOrientation(activity,requestedCameraId,camera);
  ...
  public static class SizePair {
    ...
    SizePair(int width, int height) {
      preview = new Size(width, height);
      picture = new Size(width, height);
    }
